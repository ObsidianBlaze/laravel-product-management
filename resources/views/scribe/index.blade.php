...
<head>
    ...
    <script>
        var tryItOutBaseUrl = "https://laravel-product-management-main-v8ebgm.laravel.cloud";
        var useCsrf = Boolean();
...
<aside>
    <strong>Base URL</strong>: <code>https://laravel-product-management-main-v8ebgm.laravel.cloud</code>
</aside>
...
<div class="bash-example">
    ...
    --get "https://laravel-product-management-main-v8ebgm.laravel.cloud/api/products" \
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://laravel-product-management-main-v8ebgm.laravel.cloud/api/products/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://laravel-product-management-main-v8ebgm.laravel.cloud/api/products/1"
);
